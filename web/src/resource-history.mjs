...
const existing={'attributes.initial_cents':'resourceInitialAmount','attributes.global_cents':'resourceGlobalAmount','attributes.accumulated_cents':'resourceAccumulatedAmount','attributes.planned_operating_cents':'resourceOperatingAmount','attributes.planned_investment_cents':'resourceInvestmentAmount','attributes.planned_investments':'resourceProjectAmount','attributes.declared_status':'resourceStatus','attributes.buyer_name':'resourceBuyer','attributes.starts_on':'resourceStart','attributes.ends_on':'resourceEnd','attributes.upstream_updated_at':'resourceOfficialUpdate','attributes.physical_execution_percentage':'resourcePhysicalExecution','attributes.last_measurement_on':'resourceLastMeasurement','attributes.planned_starts_on':'resourcePlannedStart','attributes.planned_ends_on':'resourcePlannedEnd','attributes.project_geometries':'resourceGeometriesConfirmed'};
