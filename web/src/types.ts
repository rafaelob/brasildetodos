...
export type Observation = {id:string; place_id:string; status:'pending'|'approved'|'rejected'|'withdrawn'|'retracted'; created_at:string; reviewed_at:string|null; observation:{mode:string; observed_on:string; body:string; reference_url:string|null}; contested?:boolean; review_note?:string|null};
